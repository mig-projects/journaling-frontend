...
import { Typography, Chip, Avatar } from "@mui/material/styles";
...
const images = [
  {
    ...
    src: `${image1}`,
    tags: ["tag1", "tag2", "tag3"],
    caption: "Here is caption1",
    ai_tags: ["ai_tag1", "ai_tag2", "ai_tag3"],
  },
  {
    id: 2,
    src: `${image2}`,
    tags: ["tag4", "tag5", "tag6"],
    caption: "Here is caption2",
    ai_tags: ["ai_tag4", "ai_tag5", "ai_tag6"],
  },
  {
    id: 3,
    src: `${image3}`,
    tags: ["tag7", "tag8", "tag9"],
    caption: "Here is caption3",
    ai_tags: ["ai_tag7", "ai_tag8", "ai_tag9"],
  },
];
    ...
    <div>
      ...
      >
        <DialogTitle
          ...
          onClose={handleClose}
        >
          <Typography variant="h5">Manage Files</Typography>
        </DialogTitle>
                ...
                <div className="carouselResults">
                  ...
                  <div className="metadata">
                    <div style={{ display: "block", textAlign: "center" }}>
                      <Typography className="mtag-label"> Our Tags:</Typography>
                    </div>
                    <div
                      className="userTags"
                      style={{
